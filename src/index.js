...
var categoriasTable = glide.table({
...
// GET
app.get("/categorias", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var categorias, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, categoriasTable.get()];
            case 1:
                categorias = _a.sent();
                res.json(categorias);
                return [3 /*break*/, 3];
...
var postCategoria = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, categoriasTable.add({ nombre: nombre })];
            case 2:
                result = _a.sent();
...
var putCategoria = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, categoriasTable.update(id, { nombre: nombre })];
            case 2:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 4];
